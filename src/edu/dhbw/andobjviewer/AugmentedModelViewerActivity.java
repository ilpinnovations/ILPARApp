...
public class AugmentedModelViewerActivity extends AndARActivity implements SurfaceHolder.Callback {
	...
	private final int MENU_SELECT_MODEL=4;
	...
	private String modelFileName="android.obj";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_SELECT_MODEL, 0, res.getString(R.string.select_model))
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
    	...
    	{
	    	menu.clear();
	    	menu.add(0, MENU_TRANSLATE, 0, "Android");
	    	menu.add(0, MENU_TRANSLATE, 0, "Chair");
	    	menu.add(0, MENU_TRANSLATE, 0, "Sofa");
	    	menu.add(0, MENU_TRANSLATE, 0, "Super Man");
	    	mode = MENU_SCALE;
    	}
    	return true;
    }*/
